...
l=$.jT()
if(l==null){P.R("  MAIN: ServiceWorkers are not supported.")
u=1
break}u=3
...
l=H.ak(h)
if(!!J.E(l).$ibr){m=l
P.R("  MAIN: "+("Error: Adding push subscription failed. "+H.i(m)))
P.R("  MAIN:        See github.com/isoos/service_worker/issues/10")}else throw h
u=8
break
case 5:u=2
break

...
l=$.j6()
if(l==null){P.Y("  MAIN: ServiceWorkers are not supported.")
u=1
break}u=3
...
l=H.ab(h)
if(!!J.G(l).$ibf){m=l
P.Y("  MAIN: "+("Error: Adding push subscription failed. "+H.k(m)))
P.Y("  MAIN:        See github.com/isoos/service_worker/issues/10")}else throw h
u=8
break
case 5:u=2
break

...
class YeelightApi {
    ...
    public YeelightApi(String ip, int port) {
     ...
     * 
     * @param props (str): Variable length argument name of property to retrieve (max 18 in one)
     *        <ul>
     *        <li>power on - smart LED is turned on / off: smart LED is turned off</li>
     ...
     *        <li>color_mode - 1: rgb mode / 2: color temperature mode / 3: hsv mode</li>
     *        <li>flowing - 0: no flow is running / 1:color flow is running</li>
     *        <li>delayoff - The remaining time of a sleep timer. Range 1 ~ 60</li>
     *        <li>(minutes)</li>
     *        <li>flow_params - Current flow parameters (only meaningful when 'flowing'</li>
     *        <li>is 1)</li>
     ...
     *        <li>bg_flow_params - Current flow parameters of background light</li>
     *        <li>bg_ct - Color temperature of background light</li>
     *        <li>bg_mode - 1: rgb mode / 2: color temperature mode / 3: hsv mode</li>
     ...
     * 
     * @param state (str): can only be `on` or `off`. `on` means turn on the smart LED, `off` means
     ...
     *        <li>5: Turn on and switch to Night light mode. (Ceiling light only).</li>
     *        </ul>
     */
     ...
     * 
     * @param ct The target color temperature. The type is integer and range is 1700 ~ 6500 (k).
     */
     ...
     * 
     * @param pc Percentage target color temperature. The type is integer and range is 0 ~ 100 (%).
     */
